...
m <- mm
m$equations <- lapply(mm$equations, remap_ast_elements)
m$equations <- lapply(m$equations, alias_ast_names, aliases = example_model$short_aliases)
write_latex(m, file = "tmp/multimod-test.tex")
