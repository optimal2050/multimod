...
- No general-purpose parsing of other languages like JuMP, Pyomo, or
  AMPL
...
- Translating symbolic equations across modeling languages (e.g., GAMS ⇄
  JuMP ⇄ Pyomo)
...
- Output rendering to:
  - Pyomo, AMPL, GMPL
  - Equation simplification and data-driven dimensions reduction
    (“folding”)
